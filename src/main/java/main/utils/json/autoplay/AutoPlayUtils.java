...
public class AutoPlayUtils {
    ...
    public static void loadRecommendedTracks(Guild guild, TextChannel channel, AudioTrack lastTrack) {
        RobertifyAudioManager.getInstance()
                .loadRecommendedTracks(RobertifyAudioManager.getInstance().getMusicManager(guild), channel, lastTrack);
    }
