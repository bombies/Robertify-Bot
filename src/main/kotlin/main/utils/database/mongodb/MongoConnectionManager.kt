...
class MongoConnectionManager {
    ...
    companion object {
        private val CONNECTION_STRING = ConnectionString(MongoDatabase.getConnectionString(Config.MONGO_DATABASE_NAME))
        ...
        fun connect(databaseKt: main.constants.database.MongoDatabase): Companion = try {
