...
class GuildDBCache private constructor() : AbstractMongoCache(GuildDB) {
    ...
    companion object {
        ...
        val ins: GuildDBCache by lazy { GuildDBCache() }
    }
    ...
    private fun loadGuild(gid: Long, attempt: Int) {
        ...
        try {
            val guildJSON = getDocument(GuildDB.Field.GUILD_ID.toString(), gid)
            if (guildJSON != null) {
