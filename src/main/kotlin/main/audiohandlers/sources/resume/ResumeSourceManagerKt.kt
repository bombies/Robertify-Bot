...
class ResumeSourceManagerKt(playerManager: AudioPlayerManager) : MirroringAudioSourceManager(playerManager, DefaultMirroringAudioTrackResolver(emptyArray())) {
    ...
    override fun loadItem(manager: AudioPlayerManager?, reference: AudioReference?): AudioItem? {
        ...
        try {
            ...
            obj.spliterator()
                .forEachRemaining { o ->
                    try {
                        val resumableTrack = ResumableTrackKt.fromJSON(o.toString())
